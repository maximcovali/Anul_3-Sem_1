...
tabel = pandas.read_csv(nume_fisier, na_values=":")
...
m = numpy.shape(h)[0]  # Numar maxim de jonctiuni
...
k = m - numpy.argmax(h[1:m, 2] - h[:(m - 1), 2])
...
t_partitii = pandas.DataFrame(index=tabel.index)
